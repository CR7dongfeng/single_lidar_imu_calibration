...
//     }
//   };
//   //LocalParameterization* local_parameterization = new
//   AutoDiffLocalParameterization<QuaternionPlus, 4, 3>;
...
class EigenQuaternionParameterization : public ceres::LocalParameterization {
 public:
	...
	//              delta[2]);
	//          if (norm_delta > 0.0) {
	//            const double sin_delta_by_delta = (sin(norm_delta) /
	//            norm_delta);
	//            double q_delta[4];
	//            q_delta[0] = cos(norm_delta);
	//            q_delta[1] = sin_delta_by_delta * delta[0];
